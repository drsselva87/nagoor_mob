...
const FirstOnboarding = ({ navigation }) => {
  const DATA = [
    ...
    },
    {
      ...
      title1:
        'Admissions are going on for Certified Courses. It is time to expand your horizons and pave the way for the future with GRIT Studies.',
    ...
    {
      title1:
        'GRIT Studies empowers educators through well researched and customermade training programs bringing greater results for schools and colleges.',
      ...
      <View style={{ width: '100%',height:'75%', marginTop: 10 }}>
        ...
        >
          ...
          <View style={{ width: '100%', alignItems: 'center' }}>
            ...
            <Text style={styles.text2}>
              Admissions are going on for Certified Courses. It is time to
              expand your horizons and pave the way for the future with GRIT
              Studies.
            </Text>
          </View>
          <View style={{ width: '100%', alignItems: 'center' }}>
            ...
            <Text style={styles.text2}>
              Making E-learning Affordable for millions. We are the shapers of
              great minds and honorable values for greater good.
            </Text>
          </View>
          <View style={{ width: '100%', alignItems: 'center' }}>
            <Image
            ...
            <Text style={styles.text2}>
              GRIT Studies empowers educators through well researched and
              customermade training programs bringing greater results for
